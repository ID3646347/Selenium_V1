...
public class Reservation_Webdriver_Exercise {
	...
	public static void main(String[] args) throws Exception{
		...
		int ordercount;
		List<WebElement> orderList = driver.findElements(By.xpath("//input[starts-with(@name,'order_id_')]"));
		ordercount = orderList.size();
		System.out.println(ordercount);
		System.out.println(orderList);
//		while(ordercount == 9){
//		//List<WebElement> orderList = driver.findElements(By.xpath("//input[starts-with(@id='order_id')]"));
//
